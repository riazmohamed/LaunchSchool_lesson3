...
When the reference is passed to the method, the method then created a new variable for both the string and the array. these variables live within the scop of the method.
